...
-- Algorithm
--
-- According to the definition, a big country meets at least one of the following two 
-- conditions: 1. It has an area of bigger than 3 million square km. 2. It has a 
-- population of more than 25 million.
--
-- So for the first condition, we can use the following code to get the big countries 
-- of this type.
...
--
-- As most people may already come into mind, we can use OR to combine these two solutions 
-- for the two sub-problems together.
--
-- MySQL
